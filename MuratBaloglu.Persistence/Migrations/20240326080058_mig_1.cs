        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeContext = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardContext = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedPhoneOne = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FixedPhoneOneExtension = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FixedPhoneTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FixedPhoneTwoExtension = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientReview = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBlogCardImage = table.Column<bool>(type: "bit", nullable: true),
                    BlogId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsSpecialityCardImage = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Files_AboutMe_AboutMeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Files_Specialties_SpecialityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Files_AboutMeId",
                table: "Files",
                column: "AboutMeId",
                unique: true,
                filter: "[AboutMeId] IS NOT NULL");
